...
public class PixelFormatComponents {

    protected List<PixelFormatComponent> component;
     ...
     * {@link PixelFormatComponent }
     * 
     * 
     */
    public List<PixelFormatComponent> getComponent() {
        if (component == null) {
            component = new ArrayList<PixelFormatComponent>();
        }
