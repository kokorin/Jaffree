...
public class FFprobe {
     ...
     * separated by :. Each section entry is composed by a section name (or unique name), optionally followed by a list
     ...
     * <p>
     * {@link Packet#getStreamIndex} can be absent in XML {@link Stream#getIndex} also can be absent in XML
     *
     * @param showEntries
     *
     * @return this
